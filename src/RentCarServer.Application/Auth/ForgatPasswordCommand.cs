...
internal sealed class ForgatPasswordCommandHandler(IUserRepository userRepository, IUnitOfWork unitOfWork, IMailService mailService) : IRequestHandler<ForgatPasswordCommand, Result<string>>
{
    public async Task<Result<string>> Handle(ForgatPasswordCommand request, CancellationToken cancellationToken)
    {
        ...
        string subject = "Şifre Sıfırlama Talimatları";
